...
(function ($) {
  ...
  setTimeout(function () {
      if (window.___browserSync___ === undefined && Number(localStorage.getItem('HKAromatide:Main:MessageShowed')) < Date.now()) {
          localStorage.setItem('HKAromatide:Main:MessageShowed', (Date.now()) + (15 * 60 * 1000))
      // eslint-disable-next-line no-alert
      //alert('You load HKAromatide\'s "main.js", \nthis file is only created for testing purposes!')
    }
  }, 1000)
  ...
  $container.append(
    '<h5>Customize HKAromatide</h5><hr class="mb-2"/>'
  )
